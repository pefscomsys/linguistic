...
<section class="about-sec parallax-section" style="background-image: url(pic1.jpg)">
  <div class="container">
    <div class="row">
      <div class="col-md-4">
        <a href="#"><img src="img6.jpg" class="col-md-12"></img></a>
      ...
      <div class="col-md-4">
        ...
        <p><a href="order4.php" class="btn btn-transparent-white btn-capsul">PLACE ORDER</a></p>
      </div>
    </div>
  </div>
</section>
