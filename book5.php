...
<section class="about-sec parallax-section" style="background-image: url(pic1.jpg)">
  <div class="container">
    <div class="row">
      <div class="col-md-4">
        <a href="#"><img src="img7.jpg" class="col-md-12"></img></a>
          ...
          <div class="book-detail-left">
            <div class="book-cover">
              ...
              <div class="book-badges">  
			    <tr>
                <td><h6>THE WOMAN WHO ATE PYTHON</h6></td>
              </tr>
              </div>
            </div>
            <table class="bibliographic-detail">
      ...
      <div class="col-md-4">
        ...
        <p><a href="order5.php" class="btn btn-transparent-white btn-capsul">PLACE ORDER</a></p>
      </div>
    </div>
  </div>
</section>
